    ...
    <div className=' h-min-full w-full '>
            <div className=' h-min-[100%]  mt-20 md:-mt-0 md:-mb-10  md:pt-0  p-5 w-full bg-blue-100 dark:bg-gray-800 items-center flex md:flex-row'>
                <div className="left h-min-full  -mb-5    p-1 md:mb-10 md:-mt-10 md:h-full w-[72%]  md:w-[50%]     flex flex-col   md:p-10 md:pt-40  justify-center  text-black dark:text-white">
                    <h1 className='text-[1rem] md:text-[3.2rem] whitespace-nowrap poppins-bold '>Check Your CIBIL Score Now</h1> 
                    ...
                    It's <span className='text-[#58b700] tracking-wide '>Free</span> Fast, and Secure!
                        ...
                        <p className='md:text-[1rem] text-[0.6rem] pt-1 md:pt-2 w-full whitespace-wrap poppins-regular'>Know where you stand with your credit score instantly and securely.</p>
