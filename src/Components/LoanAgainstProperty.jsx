...
const HomeLoan = () => {
  return (
    <div className="h-screen w-screen flex flex-col md:flex-row  items-center justify-center">
      <div className="LEFT w-full flex mt-20  bg-blue-100 dark:bg-gray-800 text-black dark:text-white justify-center overflow-hidden md:w-1/2 md:h-full items-center  p-10  ">
      <div className="banner md:h-[70%] flex flex-col ">
        <h1 className="poppins-semibold text-2xl">Loan Against Property</h1>
