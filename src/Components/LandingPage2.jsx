...
function Page2() {
  return (
    <div className=' h-full w-full '>
            <div className=' h-[100%]  md:-mt-0 md:-mb-10  md:pt-0  p-5 w-[full] bg-green-50 dark:bg-gray-800  flex flex-col-reverse md:flex-row'>
                <div className="left h-1/2 -mt-0 md:-mt-[0rem] md:h-full    md:w-[50%] flex flex-col  p-0 md:p-10 md:pt-50  justify-center  text-black dark:text-white">
                    ...
                    <h1 className='md:text-[1.7rem] text-[1.4rem] whitespace-wrap poppins-light'>
                    Made <span className='text-[#018FCF] tracking-wide '>Easy</span> – Fast, Secure & Affordable!
                        </h1>
                        <p className='md:text-[1.1rem] text-[0.9rem] pt-2 w-full whitespace-wrap poppins-extralight'>Fast approvals, minimal paperwork, and flexible repayment plans. Get your personal loan hassle-free today!
                        </p>
