  ...
  return (
    <div className=' h-min-full w-full '>
            <div className=' h-min-[100%]  mt-20 md:-mt-0 md:-mb-10  md:pt-0  p-5 w-full bg-blue-100 dark:bg-gray-800 items-center flex md:flex-row'>
                <div className="left h-min-full  -mb-5    p-1 md:mb-10 md:-mt-10 md:h-full w-[72%]  md:w-[50%]     flex flex-col   md:p-10 md:pt-40  justify-center  text-black dark:text-white">
                    <h1 className='text-[1rem] md:text-[3.3rem] whitespace-nowrap poppins-bold '>New to Credit?</h1> 
                    <h1 className='md:text-[1.6rem] text-[0.7rem]  whitespace-wrap poppins-semibold  md:-mt-2'>
                    Get <span className='text-[#58b700] tracking-wide '>Free</span> Guidance to Boost Your Score!
                        </h1>
                        <p className='md:text-[1rem] text-[0.6rem] pt-1 md:pt-2 w-full whitespace-wrap poppins-regular'>Our experts will help you improve your credit score and access better credit opportunities.</p>
                ...
                <div className="right h-full   md:p-5 flex-col md:flex-row   md:-mb-41  md:-mt-10 md:h-full  w-[40%] md:w-[50%]   md:pt-25 flex items-center justify-center">
                  ...
                  loading="lazy"
                  decoding="async" 
                  className='mt-2 h-min-[180px]  w-[78%] md:w-auto h-[170px] md:h-auto object-contain ' />
