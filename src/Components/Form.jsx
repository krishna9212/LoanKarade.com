...
const MultiStepForm = () => {
  ...
  const nextStep = () => {
    if (step === 1) {
      if (!formData.name.trim() || !formData.gender.trim() || !formData.state.trim()||!formData.city.trim() || !formData.email.trim() || !formData.phone.trim() || !formData.address.trim()) {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center mt-20 md:mt-6 justify-start bg-blue-50 dark:bg-gray-900 p-6">
      {/* Progress Bar */}
