...
function Landingpage() {
  return (
    <div className=' h-full w-full '>
            <div className=' h-[100%]  md:-mt-0 md:-mb-10  md:pt-0  p-5 w-[full] bg-white flex flex-col-reverse md:flex-row'>
                <div className="left h-1/2 -mt-10 md:-mt-[0rem] md:h-full    md:w-[50%] flex flex-col  p-0 md:p-10 md:pt-40  justify-center  text-black">
                    ...
                    <h1 className='md:text-[1.6rem] text-[1.4rem] whitespace-wrap poppins-light'>
                        ...
                        <button className='border-black border-[0.1px] hover:bg-gray-200 transition-all duration-700 text-md text-black rounded-4xl mt-5 -ml-2 md:-ml-0 p-5 px-6 cursor-pointer'>Get Started</button>
                        </div>
                </div>
